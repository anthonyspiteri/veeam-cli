---
name: "recipe-config-backup-policy-review"
version: "1.0.0"
description: "Review configuration backup policy and schedule."
metadata:
  openclaw:
    category: "recipe"
    requires:
